...
class BookCollection:
    ...
    def __init__(self):
        """Initialize a new book collection with an empty list of books and set up file storage."""
        self.book_list = []
    ...
    def read_from_file(self):
        ...
        If the file doesn't exist, it will be created with an empty collection
        """
        try:
    ...
    def save_to_file(self):
            """Store the current book collection to a JSON file for permanent storeage."""
    ...
    def delete_book(self):
            ...
            for book in self.book_list:
                if book["title"].lower() == book_title.lower(): 
                    ...
                    self.save_to_file()
                    print(f"Book removed sucessfully!\n")
                    return 
    ...
    def start_applicataion(self):
            """Run the main application loop with a user friendly menu interface."""
            while True:
                print(" ************ 📖 Welcome to Your Book Collection Manager! ***************") 
                print("1. Add a new book")
                print("2. Remove a book")
                print("3. Serch for books")
                print("4. Update book detils")
...
if __name__ == "__main__":
    ...
    book_manager.start_applicataion()
